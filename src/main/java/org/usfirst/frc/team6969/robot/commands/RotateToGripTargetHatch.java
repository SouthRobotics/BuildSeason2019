...
public class RotateToGripTargetHatch extends Command {
  
  
  public static int center;
  public static int cen;
  public static final double HATCHCENTER = 320;     // Pixycam x values go from 0 to 316 (center is 158)
  private double error;
  private double rotation;
  private double kP;

  public RotateToGripTargetHatch() {
